...
function BracketGame({ title, team1, team2, score1, score2, week }: {
  ...
  return (
    <div className="wrc-card" style={{ minWidth: 0, width: "100%" }}>
  ...
  return (
    <div className="bg-crowd bg-overlay" style={{ minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "1.5rem 1rem 3rem" }}>
        ...
        {/* Pre-season notice */}
        <div className="wrc-card" style={{ marginBottom: "1.5rem", background: "oklch(0.22 0.04 150 / 0.85)", border: "1px solid oklch(0.75 0.12 85 / 0.6)" }}>
          <div className="wrc-card-gold-stripe" />
          <div className="wrc-card-body" style={{ padding: "0.875rem 1.25rem", textAlign: "center" as const }}>
            <div style={{ fontFamily: "Barlow Condensed, sans-serif", fontSize: "0.88rem", fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase" as const, color: "oklch(0.82 0.16 85)", marginBottom: "0.35rem" }}>
              🏈 Season hasn't started yet
            </div>
            <div style={{ fontSize: "0.84rem", color: "rgba(255,255,255,0.82)" }}>
        ...
        {/* Bracket */}
        {/* On mobile: stacked rounds. On desktop: horizontal bracket */}
        <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>

          {/* Desktop: horizontal bracket row */}
          <div className="bracket-desktop" style={{ display: "none" }}>
            <div style={{ display: "flex", gap: "2rem", alignItems: "center" }}>
              <div style={{ flex: 1 }}>
                <div style={{ fontFamily: "Barlow Condensed, sans-serif", fontSize: "0.8rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase" as const, color: "rgba(255,255,255,0.85)", textAlign: "center" as const, marginBottom: "0.75rem" }}>Wild Card (Week 15)</div>
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontFamily: "Barlow Condensed, sans-serif", fontSize: "0.8rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase" as const, color: "rgba(255,255,255,0.85)", textAlign: "center" as const, marginBottom: "0.75rem" }}>Semifinals (Week 16)</div>
                <div style={{ display: "flex", flexDirection: "column" as const, gap: "1rem" }}>
              ...
              <div style={{ color: "rgba(255,255,255,0.4)", fontSize: "1.5rem" }}>→</div>
              <div style={{ flex: 1 }}>
                <div style={{ fontFamily: "Barlow Condensed, sans-serif", fontSize: "0.8rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase" as const, color: "rgba(255,255,255,0.85)", textAlign: "center" as const, marginBottom: "0.75rem" }}>Championship (Week 17)</div>
                <div className="wrc-card">
                  ...
                  <div className="wrc-card-body" style={{ padding: "0.75rem 1rem" }}>
                    {["SF Winner 1", "SF Winner 2"].map((t, i) => (
                      <div key={i} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "0.5rem 0", borderBottom: i === 0 ? "1px solid oklch(0.9 0.005 150)" : "none" }}>
          ...
          <div className="bracket-mobile">
            ...
            <div style={{ marginBottom: "1.5rem" }}>
              <div style={{ fontFamily: "Barlow Condensed, sans-serif", fontSize: "0.82rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase" as const, color: "rgba(255,255,255,0.9)", marginBottom: "0.6rem", display: "flex", alignItems: "center", gap: "0.5rem" }}>
                <span style={{ background: "oklch(0.28 0.09 150)", borderRadius: 4, padding: "2px 8px" }}>Round 1</span>
                Wild Card — Week 15
              </div>
            ...
            {/* Arrow down */}
            <div style={{ textAlign: "center" as const, color: "rgba(255,255,255,0.35)", fontSize: "1.5rem", marginBottom: "1rem" }}>↓</div>
            {/* Semifinals */}
            <div style={{ marginBottom: "1.5rem" }}>
              <div style={{ fontFamily: "Barlow Condensed, sans-serif", fontSize: "0.82rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase" as const, color: "rgba(255,255,255,0.9)", marginBottom: "0.6rem", display: "flex", alignItems: "center", gap: "0.5rem" }}>
                <span style={{ background: "oklch(0.28 0.09 150)", borderRadius: 4, padding: "2px 8px" }}>Round 2</span>
                Semifinals — Week 16
              </div>
              <div style={{ display: "flex", flexDirection: "column" as const, gap: "0.75rem" }}>
                <BracketGame title="SF 1" team1="(1) TBD" team2="WC Winner 1" score1={null} score2={null} week="Wk 16" />
            ...
            <div>
              <div style={{ fontFamily: "Barlow Condensed, sans-serif", fontSize: "0.82rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase" as const, color: "rgba(255,255,255,0.9)", marginBottom: "0.6rem", display: "flex", alignItems: "center", gap: "0.5rem" }}>
                <span style={{ background: "oklch(0.65 0.14 85)", color: "oklch(0.15 0.02 150)", borderRadius: 4, padding: "2px 8px" }}>Final</span>
