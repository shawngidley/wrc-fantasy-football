...
export default function DraftLottery() {
  ...
  return <div className="bg-stadium-night bg-overlay" style={{ minHeight: "100vh" }}><Navigation showTicker={false} teamName={franchise?.team_name} />
    ...
    <main style={{ maxWidth: 920, margin: "0 auto", padding: "1rem 1rem 3rem" }}>
      <div className="wrc-page-title" style={{ padding: "0 0 1rem" }}><h1>2026 Draft Lottery</h1><p>Sunday, August 23, 2026 · 9:00 PM ET · Six equal chances · live sixth-through-first reveal</p><p style={{ margin:".35rem 0 0", fontSize:".8rem", color:"oklch(0.68 0.05 85)" }}>The lottery does not start automatically. The commissioner must select Run Draft Lottery.</p></div>
